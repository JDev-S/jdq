        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::text('hora_inicial', '', array('id' => 'hora_inicial','class'=>'form-control',  'placeholder' => 'Escribe la hora inicial ','required' => 'required')) }}
                 ...
                 <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Hora final:</label>
                     {{ Form::text('hora_final', '', array('id' => 'hora_final','class'=>'form-control',  'placeholder' => 'Escribe la hora final ','required' => 'required')) }}
    ...
    (function($) {
        ...
        datos.forEach(objeto => {
            ...
            tmp.push(
                ...
                '<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal" data-id="' + objeto.id_horario + '" data-inicial="' + objeto.hora_inicial + '" data-final="' + objeto.hora_final + '" data-dia="' + objeto.dia + '" ><i class="fa fa-pencil-alt"></i></button>'
