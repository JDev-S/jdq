...
<main class="body-content">
            ...
            <div class="col-xl-6 col-md-12">
                <div class="ms-panel ms-panel-fh">
                    <div class="ms-panel-header">
                        <h6>Formulario de actualizar producto</h6>
                    </div>
                    <?php
                        ...
                        <form enctype="multipart/form-data" class="needs-validation clearfix" novalidate="" method="POST" action={{route('Admin_alimentos_editar')}}>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom18">Nombre del producto</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom22">Categoría</label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom12">Colores</label>
                                    <div class="input-group">
                                        <textarea rows="5" id="validationCustom12" class="form-control" placeholder="Escribe que colores hay" required="" name="color">{{$alimento->color}}</textarea>
                                        <div class="invalid-feedback">
                                            Please provide a message.
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="validationCustom12">Tallas</label>
                                    <div class="input-group">
                                        <textarea rows="5" id="validationCustom12" class="form-control" placeholder="Escribe las tallas que se encuentran" required="" name="talla">{{$alimento->talla}}</textarea>
                                        <div class="invalid-feedback">
                                            Please provide a message.
                                        </div>
                                    </div>
                        ...
                        <div class="ms-panel">
                            ...
                            <div class="ms-panel-body">
                                <div id="imagesSlider" class="ms-image-slider carousel slide" data-ride="carousel">
                                    <img src='/img/{{$alimento->fotografia_miniatura}}'>
                                </div>
                            </div>
                            @endforeach
                            ...
                            <div class="ms-panel-header new">
                                <button class="btn btn-danger" data-toggle="modal" id="extra" name="extra" data-target="#modal-5">Img extras </button>

                                <button class="btn btn-primary" data-toggle="modal" id="color" name="color" data-target="#modal-color">Img color </button>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-imagenes" class="table w-100 thead-primary">
                                <thead>
                                    ...
                                    <td style="color:#ffffff">Nombre producto</td>
    ...
    <div class="modal fade" id="modal-color" tabindex="-1" role="dialog" aria-labelledby="modal-5">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">

                <div class="modal-header bg-primary">
                    <h3 class="modal-title has-icon text-white"><i class="flaticon-placeholder"></i> Imágenes de color</h3>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>

                <div class="modal-body">
                    <button class="btn btn-success" data-toggle="modal" data-target="#insertModal2">Agregar </button>
                    <div class="ms-panel-body">
                        <div class="table-responsive">
                            <table id="data-table-color" class="table w-100 thead-primary">
                                <thead>
                                    <td style="color:#ffffff">Imagen color</td>
                                    <td style="color:#ffffff">Nombre del producto</td>
                                    <td style="color:#ffffff">Acciones</td>
                                    <!--<td style="color:#ffffff">Acciones2</td>-->
                                </thead>
                            </table>
    ...
    <!-- model insertar-->
    <div class="modal fade" id="insertModal2" tabindex="-1" role="dialog" aria-labelledby="insertModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="insertModalLabel">Agregar imágenes de colores</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="inpFile2" name="inpFile2" multiple="multiple" onchange="GetFileInfo2()">
                    ...
                    <div class="ms-panel-body">
                        <div id="imagesSlider" class="ms-image-slider carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators" id="miniatura2">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary" data-dismiss="modal" onclick="ingresar2()">Ingresar</button>
...
<div class="modal fade" id="deleteModal2" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Eliminar imagen de color del producto</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-secondary" onclick="eliminar2()">Sí</button>
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteModalLabel">Eliminar imagen extra</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<script type="text/javascript">
    /*DECLARACION DE VARIABLES GLOBALES PARA COLOR*/
    var tabla;
    var id_eliminar = "";
    var datos_datatable;
    ...
    function datatable2() {
        ...
        var url = "admin_imagenes_color/" + id_alimento;
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                datos.forEach(objeto => {
                    var tmp = [];
                    tmp.push(
                        "<img src='/img/" + objeto.imagen_color + "' style='width:50px; height:30px;'>",
                        objeto.nombre_alimento,
                        '<button type="button"  class="btn btn-danger" data-toggle="modal" data-target="#deleteModal2" data-id="' + objeto.id_imagen_color + '" data-nombre="' + objeto.nombre_alimento + '">Eliminar</button>'
                    );
                    arr.push(tmp);
                    console.log(arr);
                });
                tabla = $('#data-table-color').DataTable({
                    destroy: true,
                    data: arr,
                    columns: [{
                            tittle: "Imagen"
    ...
    $('#data-table-color').on('click', "button.btn", function() {
        //alert("hola");
    ...
    $('#deleteModal2').on('show.bs.modal', function(event) {
        ...
        id_eliminar = id;
        var modal = $(this);
        modal.find('.col-form-label').text('¿Esta seguro que desea eliminar la foto del producto: ' + nombre + '?');
    });
    ...
    function eliminar2() {
        ...
        var data = {
            id_imagen_color: id_eliminar,
            _token: token
        };

        $.ajax({
            type: "POST",
            url: "/admin_imagenes_color_eliminar",
            data: data,
    ...
    function GetFileInfo2() {
        var fileInput = document.getElementById("inpFile2");
        var message = "";
        var message2 = "";
        ...
        if (fileInput.files.length) {
            ...
            for (let i = 0; i < fileInput.files.length; i++) {
                ...
                visor.onload = function(e) {
                    ...
                    document.getElementById('visorArchivo2').innerHTML = message;
                    document.getElementById('miniatura2').innerHTML = message2;
                };
    ...
    function ingresar2() {
        ...
        var filesLength = document.getElementById('inpFile2').files.length;
        for (var i = 0; i < filesLength; i++) {
            formData.append("file[]", document.getElementById('inpFile2').files[i]);
        }
        ...
        $.ajax({
            ...
            type: "POST",
            contentType: false,
            url: "/Admin_imagenes_color_insertar",
            data: formData,
            processData: false,
            cache: false,
            success: function(msg) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                datos.forEach(objeto => {
                    var tmp = [];
                    tmp.push(
                        "<img src='/img/" + objeto.imagen_muestra + "' style='width:50px; height:30px;'>",
                        objeto.nombre_alimento,
