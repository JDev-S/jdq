...
<script type="text/javascript">
    (function($) {
        ...
        datos.forEach(objeto => {
            var tmp = [];
            tmp.push(
                " <img src='/img/" + objeto.fotografia_miniatura + "' style='width:50px; height:30px;'>" + objeto.nombre_alimento,
                //objeto.descripcion,
...
<script type="text/javascript">
    $('#deleteModal').on('show.bs.modal', function(event) {
        ...
        var modal = $(this)
        modal.find('.col-form-label').text('¿Esta seguro que desea eliminar el producto:' + alimento + '?')
