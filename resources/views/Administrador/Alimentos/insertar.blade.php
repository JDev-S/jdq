            ...
            <div class="col-xl-6 col-md-12">
                <div class="ms-panel ms-panel-fh">
                    <div class="ms-panel-header">
                        <h6>Formulario para agregar un producto</h6>
                    </div>
                    <?php
                        ...
                        <form enctype="multipart/form-data" class="needs-validation clearfix" novalidate="" method="POST" action={{route('Admin_alimentos_nuevo')}}>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        <textarea rows="5" id="validationCustom12" class="form-control" placeholder="Escribe que colores hay" required="" name="color"></textarea>
                                        <div class="invalid-feedback">
                                            Please provide a message.
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        <textarea rows="5" id="validationCustom12" class="form-control" placeholder="Escribe las tallas que se encuentran" required="" name="talla"></textarea>
                                        <div class="invalid-feedback">
                                            Please provide a message.
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="ms-panel">
                            ...
                            <div class="ms-panel-header new">
                                <p class="medium">Se encuentra disponible</p>
                                <div>
